...
public class Main
{
    ...
    {
        FileInputStream parkPhoto = new FileInputStream("ParkPhotos.txt");
        Scanner scan = new Scanner(parkPhoto);

        while(scan.hasNextLine())
        {
            String line = scan.nextLine();
            System.out.println(line.substring(0, (line.length()- 10)) + "_info.txt");
        }
    }
}
```
